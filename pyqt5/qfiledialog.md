...
class MainForm(QWidget):
    ...
    def slot_btn_chooseFile(self):
        fileName_choose, filetype = QFileDialog.getOpenFileName(
            ...
            "选取文件",
            self.cwd, # 起始路径
            "All Files (*.png);;Text Files (*.txt)" # 设置文件扩展名过滤,用双分号间隔
        )
...
{% embed url="https://www.tutorialspoint.com/pyqt5/pyqt5\_qfiledialog\_widget.htm" %}



{% embed url="https://blog.csdn.net/humanking7/article/details/80546728" %}
